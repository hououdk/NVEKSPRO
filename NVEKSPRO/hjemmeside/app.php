...
<?php include_once("analyticstracking.php") ?>
	...
	<div class="menu">
		...
		<a href="app.php" class="selected">App</a>
	</div>
	</nav>
	...
	<div class="container">
		<div class="content">
			...
			<h1>App</h1>
			<br>
			<h2>Ved du ikke hvem du skal stemme på?</h2>
			<br>
			</div>
		<div class="NemtValg-pics">
<a href="https://youtu.be/XeVtsGkJF4g" data-fancybox="video" class="nvv">
	<div class="videobox"></div>
		...
		<div class="text">
			...
			<div class="kolonne">
				...
				<br>
				<p>
					I vores gratis app har du mulighed for at swipe igennem dine lokale politikere. <br><br>
					Når du har fundet de politikere du er enig med, kan du sammenligne dem, og til sidst står du med en enkelt politiker.<br><br>
				</p>
			</div>	
			<div class="kolonne2">
			<h2>
			...
			<br>
			<br>
				<img class="appikon" src="billeder/Play Store.svg" alt="NemtValg Play Butik">
				<br>
				<img class="appikon" src="billeder/App Store.svg" alt="NemtValg App store">
				<br><br>
			</div>
