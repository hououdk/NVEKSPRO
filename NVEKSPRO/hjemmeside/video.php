...
<?php include_once("analyticstracking.php") ?>
	...
	<div class="menu">
		...
		<a href="video.php" class="selected">Videoer</a>
	...
	<div class="container">
		<div class="content">
			...
			<h1>Videoer</h1>
			<br>
			<h2>Orker du heller ikke huller i vejene?</h2>
			<br>
		<div class="NemtValg-pics">
<a href="https://youtu.be/0LodYTHXo-Y" data-fancybox="video" class="nvv">
	<img class="videobillede" src="billeder/bil1-play.jpg" alt="NemtValg film">
</a>		</div>
			<br>
			<br>
			<h2>Er du også træt af højt græs på fodboldbanerne?</h2>
			<br>
			<div class="NemtValg-pics">
	<img class="videobillede" src="billeder/grass.jpg" alt="NemtValg film">
</a>		</div>
			<br>
			<h2>Ny video hver uge</h2>
			<br>
			<p>Vi udgiver en ny video i serien "Hvad kan min kommune gøre for mig" hver mandag op til valget</p>
			<br>
			<br>
		</div>
		</div>
